    ...
    public static String getMensaje(int cod) {
        ...
        switch(cod) {
            ...
            case 103:
                ...
                break;
            case 104:
                mensaje = mensaje + "no existe este usuario en la base de datos";
                break;
            case 105:
            ...
            case 108:
                ...
                break;
            case 109:
            mensaje = mensaje + "ha excedido el numero de mundiales permitidos (20)";
                break;
            case 110:
                mensaje = mensaje + "El código de patrocinador ya existe.";
                break;
            //Tomas: más casos
            default:
